...
```bash
git remote add encore encore://job-application-assistant-5xpi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/job-application-assistant-5xpi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/job-application-assistant-5xpi/settings/integrations/github)
