...
import { Code, Globe, Plus, Trash2, Star } from 'lucide-react';
...
export default function SkillsLanguagesForm({ userProfile }: SkillsLanguagesFormProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <Card className="border-0 shadow-lg">
        ...
        <CardContent>
          <form onSubmit={handleLanguagesSubmit} className="space-y-6">
